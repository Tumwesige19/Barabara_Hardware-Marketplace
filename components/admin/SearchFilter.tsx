...
import { useDebounce } from '@/lib/hooks'; // We'll need to create this or implement debounce inline
...
export function SearchFilter() {
    ...
    const updateParams = (searchTerm: string, statusTerm: string) => {
        const params = new URLSearchParams(searchParams.toString());

        if (searchTerm) params.set('search', searchTerm);
        else params.delete('search');

        if (statusTerm && statusTerm !== 'All') params.set('status', statusTerm);
